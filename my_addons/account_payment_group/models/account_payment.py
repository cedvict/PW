...
class AccountPayment(models.Model):
    ...
    @api.multi
    # this onchange is necesary because flectra, sometimes, re-compute
    ...
    # rouding flectra believes amount has changed)
    ...
    def check_payment_group(self):
        # TODO check this
        # we add this key mainly for flectra test that are gives error because no
